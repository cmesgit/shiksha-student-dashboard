...
// "in 25 min" read identically everywhere a session row appears (Dashboard's
// SessionCard rows, LiveSessions' own rows, …) instead of each page hand-
// rolling its own slightly different formatting.
